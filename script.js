...
// Preferred path: hits our own /api/status serverless function. This runs
// server-side (Vercel), so it can read the full response body and tell the
// difference between "online", "under maintenance", and "down".
